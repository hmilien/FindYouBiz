...
class Template extends WP_REST_Posts_Controller
{
	...
	protected $_listify = 'listify child';
	protected $_listingPro = 'listingpro child';
	protected $_myListing = 'my listing';
	protected $_jobify = 'jobify - classic';
	...
	public function add_custom_type_to_rest_api()
	{
		...
		$taxonomy_name = array('job_listing_category','region', 'features', 'job_listing_type', 'job_listing_region', 'location');
